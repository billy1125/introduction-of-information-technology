...
但這一切不是憑空出現的，它是幾十年來無數次技術突破的結果；現代電腦的發展通常被理解為由機械計算、機電資料處理、電子計算、個人電腦、網路化與行動運算逐步累積而成的長期演進（Campbell-Kelly et al., 2018; Ceruzzi, 2003）。
...
自古以來，人類的生活從未離開過「資訊」。當原始人看到天空烏雲密布，判斷即將下雨而躲進洞穴，這就是資訊處理的最初形態。資訊是人類做出決策、與他人溝通、以及傳承知識的基礎；從書寫、記帳到機械計算，資訊處理的歷史也常被視為文明管理複雜度的歷史（Aspray, 1990; Ifrah, 2000）。
...
十九世紀末，電力技術的成熟開啟了計算工具的新篇章。特別是打孔卡與機電式製表設備，使資料處理從人工統計逐步轉向大規模自動化（Campbell-Kelly et al., 2018）。
...
**預測性維護（Predictive Maintenance）**：前面「九、現代資訊系統」提過，工業物聯網（IoT）設備會持續回傳機台的溫度、震動等感測資料；AI 能從這些歷史資料中學習正常與異常的模式，提前[預測性維護](https://zh.wikipedia.org/zh-tw/%E9%A2%84%E6%B5%8B%E6%80%A7%E7%BB%B4%E6%8A%A4)機台可能發生故障的時間點，讓廠務團隊能在真正停機之前安排維修，避免產線意外中斷造成的損失。這是與工業工程管理最相關的一項 AI 應用，它在智慧工廠中的完整樣貌，見 [07-Industry-4.0-and-Smart-Manufacturing.md](07-Industry-4.0-and-Smart-Manufacturing.md)〈三、AI 在製造中的應用〉。
...
> **銜接提示**：本章走過的這條「從算盤到 AI」的長路，會在全課程最後的 [07-Industry-4.0-and-Smart-Manufacturing.md](07-Industry-4.0-and-Smart-Manufacturing.md) 中收束成一座真實的智慧工廠——屆時你會發現，這裡提到的每一個里程碑，都還活在那座工廠的某個角落：二進位活在感測器的讀值裡，網路活在機台與雲端之間，而 AI 活在那張預測機台何時故障的報表上。

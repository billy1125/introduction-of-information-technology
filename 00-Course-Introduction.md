...
> **文件很長，但每一條都會影響你的成績。請不要只在第一週聽老師講過一次就算了——找時間自己從頭到尾讀完一遍。學期中真的出狀況時，老師是依這份文件處理，不是依你記得的版本。**
...
這半學期的上課方式、教材與評分，孫老師會在他自己的課堂上說明，**這份文件不代為公告**。輪到孫老師上課時，請記得把他那部分的規定聽清楚、當場問清楚。

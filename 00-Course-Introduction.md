...
呂老師這半學期不出作業、也不要求做報告，成績只看期中考這一次，**原因是 AI 已經讓作業與報告很難測出你到底學了多少**。不同的課會有不同的做法：呂老師另一門「系統分析與設計」不適合用考試評量，改成做報告，但要配上上台報告、老師當場提問與面對面訪談，才能確認分數是你自己的。這門課的時數不夠，做不到這種評量方式。

《經濟學人》整理過一份追蹤中國 26,811 名學生的研究（The Economist, 2026）：用 AI 寫作業的學生，作業成績進步 18%，寫作業時間從 64 分鐘縮短到 45 分鐘；**但到了大考，這群人比從沒用過 AI 的學生退步 20%**。作業寫得越快越漂亮，考出來反而越差。同一份研究也指出，**成績沒退步的是「用了 AI 但時間沒省下來」的那群人——他們拿 AI 解釋觀念，而不是直接生成答案**。

所以只考一次試，不是為了刁難你，而是在這門課的條件下，考試是唯一還測得出「你自己會多少」的方式。

這不代表你不能用 AI。拿 AI 整理教材重點、把不懂的地方講到你聽懂、出練習題考自己，老師都鼓勵你這樣準備考試。差別在於：用它幫你弄懂觀念，而不是用它替你交差。

![經濟學人研究](images/00-Course-Introduction/why-test.jpg)
...
這張表不是窮舉，沒有列到的情況一樣拿上面三個條件去判斷。要特別提醒最後兩類：**塞車誤點、睡過頭、忘記帶東西，都請自己留緩衝**，考試日期你老早就知道了。當然也有例外：台鐵人身事故、電車線斷落這類重大事故，如果是你已經在車上才發生，就屬於三個條件同時成立，算不可抗力。

> **什麼算、什麼不算不可抗力，不是看這張表列了哪些項目，而是看那三個條件有沒有同時成立。**
...
> **請注意**：簽到與簽退時間一到，助教會等所有同學簽到退完成後，立刻離開現場，請同學不可因為個人因素干擾助教進行前述的工作！或者事後再找助教補簽，違者將依照學校規定處理
...
- 前面從「資訊需求」到「AI」的演進，正在製造現場重演一次，這就是工業4.0。
- 工廠的演進階段：工業1.0 蒸汽帶來機械化，工業2.0 電力與生產線達成量產，工業3.0 導入電腦與自動化（可程式邏輯控制器 PLC、CNC 工具機）讓機台能被程式控制。2011 年德國提出工業4.0，主軸是「連結」與「智慧」，把網路、資料與 AI 導入工廠。
- 現場的資訊需求：良率、排程、稼動率、設備健康都需要判讀資料，過去仰賴人工記錄與經驗判斷。
- 連結：在設備上裝感測器，透過工業物聯網（Industrial IoT, IIoT）即時蒐集溫度、振動、電流、產量等資料，讓孤立的機台形成網路，對應「網路與網際網路」該章。
- 資訊系統：製造執行系統（MES）銜接現場與管理層，往上與 ERP、SCM 整合，使訂單從接單、排程、生產到出貨全程可視。智慧工廠因此形成現場層、控制層、管理層、雲端層由下而上的分層架構，對應「資訊系統」該章。
- 資料科學與 AI：機台資料經分析後產生三類代表性應用——以歷史資料預測設備故障的預測性維護、以視覺辨識挑出瑕疵品的智慧檢測，以及在虛擬環境建立產線模型、以模擬取代實體試錯的數位孿生（Digital Twin）。
- 計算機、程式、網路、資訊系統、資料科學與 AI 這條技術主線，在此匯流成能自我感知、連結與決策的智慧工廠，也是工業工程與管理領域的下一階段課題。
...
記住一個原則： **資訊與數位科技的本質，是幫助人類有效處理資料、把資料轉化為有用的資訊，最終形成能支援決策的知識。**

從結繩記事、算盤、機械計算機、真空管計算機，到電晶體與積體電路電腦、電腦結構與程式設計、網路與網際網路、電腦資訊系統，再到近代的物聯網、大數據與人工智慧，全部都是為了這個最基本的需求而存在。技術的推演與應用的創新，都是為了把這件事做得更好而持續改進。

所以讀這一科不要死背硬記。看到一項技術時，隨時想想並且想像（想像很重要）三個問題：

1. 為什麼會出現這項技術？
2. 它是為了解決什麼問題？
3. 問題解決之後，又產生或發現了什麼新問題？

順著這三個問題讀，整門課會像看故事書一樣好懂，也不會落入背了一堆名詞、算了一堆數學，卻不知道為什麼要學的狀況。

以上是教了四年多計算機概論的老師，給修課同學的建議。
...
- 元智大學（無日期）。《元智大學學則》。https://web.yzu.edu.tw/

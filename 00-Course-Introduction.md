...
你的系學長分享了他第一天工廠實習的經歷：主管叫他「去 MES 系統確認今天的工單進度，再把良率資料匯出來，讓 AI 分析一下趨勢」。
...
> **這就是這門課的核心價值**：不是要把你訓練成工程師，而是讓你具備「在數位化工廠與企業中有效工作的資訊素養」——聽得懂技術語言、讀得懂資料報告、說得清楚系統需求。
...
> 你不需要記住每一個技術細節，但學完這門課後，面對資訊系統、資料分析、AI 應用等工作場景，你應該知道「這是什麼、它在做什麼、我該如何判斷好壞」。這就是這門課真正想給你的能力。

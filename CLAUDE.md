...
**例外**：`00-Course-Introduction.md` 與 `00-Course-Rules-Quiz.md` 雖然檔名同樣是 `0X-XXX` 形式，但屬於課程行政文件而非教材章節，**不適用章節撰寫規範**——沒有章節標題副標、學習重點總結、參考文獻與銜接提示。這兩份只需遵守下方三條硬規則與中文排版規範。
...
| CPU、記憶體、儲存裝置等硬體 | `02-Computer-Structure.md`〈第四篇：硬體層面〉 |
| 作業系統（行程、記憶體管理、檔案系統） | `02-Computer-Structure.md`〈第五篇：軟體層面〉 |
